function konversikefahrenheit() {
    ...
    // Validasi angka jika kosong
    if (isNaN(value)) {
      celsiusError.textContent = "hatimu bole kosong, tapi yang ini gabolee";
    ...
    // Tampilan perhitungan di konversi celcius ke fahrenheit
  ...
  function konversikecelcius() {
    ...
    // Validasi angka jika kosong
    if (isNaN(value)) {
      fahrenheitError.textContent = "hatimu bole kosong, tapi yang ini gabolee";
    ...
    // Tampilan perhitungan di konversi fahrenheit ke celcius
